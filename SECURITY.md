...
To document a security concern, communication is facilitated with the project curators:
  ...
  - **Method**: Reports are submitted via the repository’s [GitHub Issues](https://github.com/Amey-Thakur/ANDROID-STUDIO-FLASHLIGHT/issues) interface to formally record security-related findings.
...
## Implementation Context: Android Studio Flashlight

This project consists of a simple Flashlight application built using Java and Android Studio, leveraging the Camera2 API for LED control.

-   **Scope Limitation**: This policy applies exclusively to the documentation, code, and assets contained within this repository and does not extend to the runtime environment (Android OS) or third-party libraries.
...
*This document defines the security posture of a finalized Java project.*
